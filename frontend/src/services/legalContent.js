  ...
  comun: [
    {
      ...
      texto: `Blockhome (en adelante "el Sistema") es responsable del tratamiento de sus datos personales.
Para ejercer sus derechos o resolver dudas puede contactarnos en: privacidad@blockhome.mx`
    },
    {
  ...
  comun: [
    {
      ...
      texto: `Blockhome es una plataforma digital que facilita el contacto entre estudiantes del Instituto Politécnico Nacional (IPN) que buscan arrendamiento y personas físicas que desean ofrecer inmuebles en renta. No somos parte de ningún contrato de arrendamiento.`
    },
    {
...
Queda prohibido publicar información falsa, usar el sistema para actividades ilícitas, acosar a otros usuarios o intentar vulnerar la seguridad de la plataforma.`
    },
    {
      ...
      texto: `El diseño, código fuente, logotipos y contenidos del sistema son propiedad de Blockhome o de sus licenciantes. No se permite su reproducción, distribución o modificación sin autorización expresa por escrito.`
    },
    {
      subtitulo: '5. Limitación de Responsabilidad',
      texto: `Blockhome actúa como intermediario tecnológico. No nos hacemos responsables de: la veracidad de los anuncios publicados por los usuarios, los acuerdos económicos o legales celebrados entre arrendadores y arrendatarios, ni de daños derivados del uso indebido de la plataforma por parte de terceros.`
    },
    {
    ...
    },
    {
      ...
      texto: `Para reportes, quejas o aclaraciones: contacto@blockhome.mx`
    }
  ],
  // Sección 2 diferente por rol
  condicionesPorRol: {
